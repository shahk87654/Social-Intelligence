...
export default function LoginPage() {
  ...
  return (
    <main className="grid min-h-screen lg:grid-cols-[0.9fr_1.1fr]">
      <aside className="hidden bg-slate-950 p-12 text-white lg:flex lg:flex-col lg:justify-between"><div><img src="/logo.png?v=4" alt="Social Intelligence" width={401} height={140} className="block h-auto w-48 object-contain object-left" /><div className="mt-28 max-w-sm"><p className="text-xs font-semibold uppercase tracking-[0.22em] text-cyan-400">Signal over noise</p><h2 className="mt-5 text-5xl font-semibold leading-[1.05]">Know what people are saying.</h2><p className="mt-6 text-base leading-7 text-slate-400">A focused workspace for tracking public conversation, emerging risks, and the stories shaping your market.</p></div></div><p className="text-xs text-slate-500">Private workspace intelligence</p></aside>
      <section className="flex items-center justify-center px-4 py-10 sm:px-8">
        <div className="w-full max-w-md">
        <div className="mb-10 lg:hidden"><img src="/logo.png?v=4" alt="Social Intelligence" width={401} height={140} className="block h-auto w-36 object-contain object-left invert dark:invert-0" /></div>
