...
export default function ReportsPage() {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-[1500px] px-4 py-6 sm:px-6 lg:px-8">
      <nav className="mb-10 flex items-center justify-between border-b border-slate-200 pb-5">
        <a href="/" className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-blue-600 to-violet-600 text-sm font-black text-white shadow-lg shadow-blue-500/20">SI</div>
          <div><div className="text-sm font-semibold tracking-tight text-slate-900">Signal / Intel</div><div className="text-[10px] uppercase tracking-[0.18em] text-slate-400">HQ research console</div></div>
        </a>
        <div className="flex items-center gap-2 text-xs">
          <a href="/" className="rounded-lg px-3 py-2 text-slate-500 hover:bg-slate-100">Overview</a>
          <a href="/reports" className="rounded-lg bg-blue-50 px-3 py-2 font-semibold text-blue-700">Reports</a>
        </div>
      </nav>
