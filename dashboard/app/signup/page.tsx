...
export default function SignupPage() {
  ...
  return (
    <main className="grid min-h-screen lg:grid-cols-[1.1fr_0.9fr]"><aside className="hidden bg-blue-600 p-12 text-white lg:flex lg:flex-col lg:justify-between"><img src="/logo.png?v=4" alt="Social Intelligence" width={401} height={140} className="block h-auto w-48 object-contain object-left" /><div className="max-w-md"><p className="text-xs font-semibold uppercase tracking-[0.22em] text-blue-100">A clearer read on the market</p><h2 className="mt-5 text-5xl font-semibold leading-[1.05]">Build your listening post.</h2><p className="mt-6 text-base leading-7 text-blue-100">Bring your own service keys, invite your team, and turn public conversation into useful decisions.</p></div></aside><section className="flex items-center justify-center px-4 py-10 sm:px-8"><div className="w-full max-w-md"><div className="mb-10"><img src="/logo.png?v=4" alt="Social Intelligence" width={401} height={140} className="block h-auto w-36 object-contain object-left invert dark:invert-0" /></div>
